...
SRC			=	main.c ft_utils.c ft_utils_num.c ft_utils_mlx_linux.c ft_arg_check.c ft_list_builder.c diagnostics.c ft_exit_free.c ft_screen_maker.c \
				...
				ft_fill_vo.c ft_create_gol_geo_obj.c ft_create_gol.c ft_value_assignemnt.c ft_calc_light.c ft_arg_check_vo.c ft_arg_check_go.c\
				ft_arg_check_utils.c ft_create_light_stuff_vec.c
